...
import { setMessage } from "../../store/message-slice.js";
...
function OAuth({ loading, setLoading }) {
  ...
  return (
    <div className="oauth-social">
      <div className="text-wrap-oauth">
        <div className="text-line-oauth"></div>
        <p className="text-oauth">Hoặc</p>
        <div className="text-line-oauth"></div>
      </div>
      <button
      ...
      >
        ...
        <span>
          {loading ? (
            <Spin text="Đăng nhập bằng Google" />
          ) : (
